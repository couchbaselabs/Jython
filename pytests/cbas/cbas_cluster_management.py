...
#
    ...
    def test_add_delete_cbas_nodes_CLI(self):
        ...
        for cbas_server in self.cbas_servers:
            ...
            stdout, stderr, result = CouchbaseCLI(
                self.master, self.master.rest_username,
                self.master.rest_password).server_add(
                "https://"+cbas_server.ip+":18091",
                cbas_server.rest_username, cbas_server.rest_password,
                None, service, None)
